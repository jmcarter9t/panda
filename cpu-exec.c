...
/* main execution loop */
// JMC: This gets called repeatedly by cpu_loop in linux-user/main.c
// cpu_loop handles interrupts generated by this function.
...
int cpu_exec(CPUState *cpu)
{
    ...
    while (!cpu_handle_exception(cpu, &ret)) {
        ...
        // JMC: Almost all of this loop is new panda code with the 
        // exception of the tb_find( ... ) call
